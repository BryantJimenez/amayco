			...
			<div class="widget-content widget-content-area">
				...
				<div class="row">
					<div class="col-12">
						...
						<form action="{{ route('transfer.update', ['slug' => $transfer->slug]) }}" method="POST" class="form" id="formTransferEdit" enctype="multipart/form-data">
							@csrf
							@method('PUT')
							<div class="row">
								<div class="form-group col-12">
									<label class="col-form-label">Título<b class="text-danger">*</b></label>
									<input class="form-control" type="text" name="name" required placeholder="Introduzca un título" value="{{ $transfer->name }}">
								</div>

								<div class="form-group col-12">
									<label class="col-form-label">Descripción<b class="text-danger">*</b></label>
									<textarea class="form-control" required name="description" placeholder="Introduce una descripción" rows="5" id="content-about">{{ $transfer->description }}</textarea>
								</div>
								...
								<div class="form-group col-xl-6 col-lg-6 col-md-6 col-12">
									...
									<select class="form-control" name="lang">
										...
										<option value="en" @if($transfer->lang=='en') selected @endif >Inglés</option>
										<option value="es" @if($transfer->lang=='es') selected @endif >Español</option>
									</select>
								</div>
								...
								<div class="form-group col-12">
									<div class="btn-group" role="group">
										...
										<a href="{{ route('transfer.index') }}" class="btn btn-secondary">Volver</a>
									</div>
								</div> 
							</div>
						</form>
