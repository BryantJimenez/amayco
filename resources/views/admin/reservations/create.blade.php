			...
			<div class="widget-content widget-content-area">
				...
				<div class="row">
					<div class="col-12">
						...
						<form action="{{ route('reservation.store') }}" method="POST" class="form" id="formReservationCreate" enctype="multipart/form-data">
							@csrf
							<div class="row">
								<div class="form-group col-12">
									<label class="col-form-label">Reservación<b class="text-danger">*</b></label>
									<input class="form-control" type="text" name="reservation" required placeholder="Introduzca un reservación" value="{{ old('reservation') }}">
								</div>
