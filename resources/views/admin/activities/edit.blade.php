			...
			<div class="widget-content widget-content-area">
				...
				<div class="row">
					<div class="col-12">
						...
						<form action="{{ route('activity.update', ['slug' => $activity->slug]) }}" method="POST" class="form" id="formActivityEdit" enctype="multipart/form-data">
							@csrf
							@method('PUT')
							<div class="row">
								<div class="form-group col-6">
									<label class="col-form-label">Nombre<b class="text-danger">*</b></label>
									<input class="form-control" type="text" name="name" required placeholder="Introduzca un nombre" value="{{ $activity->name }}">
								</div>
								...
								<div class="form-group col-xl-6 col-lg-6 col-md-6 col-12">
									...
									<select class="form-control" name="lang">
										...
										<option value="en" @if($activity->lang=='en') selected @endif >Inglés</option>
										<option value="es" @if($activity->lang=='es') selected @endif >Español</option>
									</select>
								</div>
