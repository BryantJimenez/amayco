			...
			<div class="widget-content widget-content-area">
				...
				<div class="row">
					<div class="col-12">
						...
						<form action="{{ route('galeria.store') }}" method="POST" class="form" id="formGallery" enctype="multipart/form-data">
							@csrf
							<div class="row">
								...
								<div class="form-group col-12">
									...
									<input type="file" name="image" required accept="image/*" id="input-file-now" class="dropify" data-height="125" data-max-file-size="20M" data-allowed-file-extensions="jpg png jpeg web3" />
								</div>
