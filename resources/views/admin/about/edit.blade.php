			...
			<div class="widget-content widget-content-area">
				...
				<div class="row">
					<div class="col-12">
						...
						<form action="{{ route('about.store', ['slug' => $about->slug]) }}" method="POST" class="form" id="formAboutCreate" enctype="multipart/form-data">
							@csrf
							<div class="row">

								<div class="form-group col-12">
									<label class="col-form-label">Descripción<b class="text-danger">*</b></label>
									<textarea class="form-control" required name="description" placeholder="Introduce una descripción" id="content-about" rows="5">{{ $about->description }}</textarea>
								</div>

								<div class="form-group col-xl-6 col-lg-6 col-md-6 col-12">
									<select class="form-control" name="lang">
										<option value="">Seleccione</option>
										<option value="en" @if($about->lang=='en') selected @endif >Inglés</option>
										<option value="es" @if($about->lang=='es') selected @endif >Español</option>
									</select>
								</div>
