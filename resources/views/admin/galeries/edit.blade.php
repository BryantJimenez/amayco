			...
			<div class="widget-content widget-content-area">
				...
				<div class="row">
					<div class="col-12">
						...
						<form action="{{ route('galery.update', ['slug' => $galery->slug]) }}" method="POST" class="form" id="formGaleryEdit" enctype="multipart/form-data">
							@csrf
							@method('PUT')
							<div class="row">
								<div class="form-group col-xl-6 col-lg-6 col-md-6 col-12">
									...
									<select class="form-control" name="category_id">
										...
										<option @if($galery->category_id==$c->id) selected @endif value="{{ $c->id }}">{{ $c->name }}</option>
										@endforeach
									</select>
								</div>
								...
								<div class="form-group col-6">
									...
									<input class="form-control" type="text" name="title" required placeholder="Introduzca un título" value="{{ $galery->title }}">
								</div>

								<div class="form-group col-12">
									<label class="col-form-label">Imagen<b class="text-danger">*</b></label>
									<input type="file" name="image" accept="image/*" id="input-file-now" class="dropify" data-height="125" data-max-file-size="20M" data-allowed-file-extensions="jpg png jpeg web3" data-default-file="{{ '/admins/img/galeries/'.$galery->image }}" />
								</div>
								...
								<div class="form-group col-xl-6 col-lg-6 col-md-6 col-12">
									...
									<select class="form-control" name="lang">
										<option value="">Seleccione</option>
										<option value="en" @if($galery->lang=='en') selected @endif >Inglés</option>
										<option value="es" @if($galery->lang=='es') selected @endif >Español</option>
									</select>
								</div>
