...
@section('title', 'Crear Datos de Oficina')
			...
			<div class="widget-content widget-content-area">
				...
				<div class="row">
					<div class="col-12">
						...
						<form action="{{ route('office.store') }}" method="POST" class="form" id="formofficeCreate" enctype="multipart/form-data">
							@csrf
							<div class="row">
								<div class="form-group col-12">
									<label class="col-form-label">Dirección<b class="text-danger">*</b></label>
									<textarea class="form-control" required name="address" placeholder="Introduce la dirección" rows="5">{{ old('address') }}</textarea>
								</div>
								...
								<label class="col-form-label">Correo<b class="text-danger">*</b></label>
									<input class="form-control" type="email" name="email" required placeholder="Introduzca un teléfono" value="{{ old('email') }}">
								</div>
