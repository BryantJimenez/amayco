					...
					<div class="col-xl-5 col-12 mb-3">
						<div class="card bg-dark">
							<div class="card-body">
								...
								<h6 class="text-white font-weight-bold">Administre toda su empresa de forma simple, fácil, comoda y a medida!</h6>
							</div>
						</div>
					</div>
						...
						<div class="row">
							...
							<div class="col-xl-6 col-md-6 col-sm-6 col-12 mb-3"> 
								<div class="card bg-secondary">
									<div class="card-body">
										<h5 class="card-text text-white text-center font-weight-bold">Excursiones</h5>
										<h2 class="text-white text-center font-weight-bold">0</h2>
									</div>
								</div>
							</div>
