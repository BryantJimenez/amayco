...
@section('title', 'Editar Home-Page')
			...
			<div class="widget-content widget-content-area">
				...
				<div class="row">
					<div class="col-12">
						...
						<form action="{{ route('home.update', ['slug' => $home->slug]) }}" method="POST" class="form" id="formHomeEdit" enctype="multipart/form-data">
							@csrf
							@method('PUT')
							<div class="row">
								<div class="form-group col-4">
									<label class="col-form-label">Título Uno<b class="text-danger">*</b></label>
									<input class="form-control" type="text" name="title_one" required placeholder="Introduzca un título" value="{{ $home->title_one }}">
								</div>

								<div class="form-group col-4">
									<label class="col-form-label">Título Dos<b class="text-danger">*</b></label>
									<input class="form-control" type="text" name="title_two" required placeholder="Introduzca un título" value="{{ $home->title_two }}">
								</div>

								<div class="form-group col-4">
									<label class="col-form-label">Título 3<b class="text-danger">*</b></label>
									<input class="form-control" type="text" name="title_three" required placeholder="Introduzca un título" value="{{ $home->title_three }}">
								</div>

								<div class="form-group col-12">
									<label class="col-form-label">Imagen<b class="text-danger">*</b></label>
									<input type="file" name="image" accept="image/*" id="input-file-now" class="dropify" data-height="125" data-max-file-size="20M" data-allowed-file-extensions="jpg png jpeg web3" data-default-file="{{ '/admins/img/homes/'.$home->image }}" />
								</div>
								...
								<div class="form-group col-xl-6 col-lg-6 col-md-6 col-12">
									...
									<select class="form-control" name="lang">
										...
										<option value="en" @if($home->lang=='en') selected @endif >Inglés</option>
										<option value="es" @if($home->lang=='es') selected @endif >Español</option>
									</select>
								</div>
